...
2. 조금 더 가볼까? 현상이 TRUE인 경우가 몹시 드물다고 해보자. 99%가 FALSE이고 1% 정도만 TRUE라면? 이 경우 $\beta = 0.6$, $\alpha = 0.05$가정할  FPRP는 무려 0.93이 된다. 즉, 이오니디스 선생의 주장대로 대부분의 연구가 가짜 연구가 된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU4OTg3MDYzLC0xNDE1NTE4MzU4LC0xMz
